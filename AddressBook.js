...

{
    ...
    AddressBookArray.push(new AddressBook("Lavanya", "Gangadharan", "Vellore", "Chennai", "Tamilnadu", "602845", "8096743215", "lavanya9@gmail.com"));
    AddressBookArray.push(new AddressBook("Ganesh", "Kanna", "City Center", "Chennai", "Tamilnadu", "509832", "9654310542", "ganesh8@gmail.com"));
    AddressBookArray.push(new AddressBook("Sandhiya", "natrajan", "Annanagar", "Chennai", "Tamilnadu", "589245", "9807635214", "sandhiya11@gmail.com"));
    
    AddressBookArray.find(contact => contact.firstName == 'Ganesh').firstName = 'Ganesh';
      //DeleteContact
    {    
        let indexToBeDel = AddressBookArray.indexOf(contact => contact.firstName=='Ganesh')
    ...
    //DuplicateEntry
    {
        let newContact = new AddressBook("Ganesh", "Kanna", "City Center", "Chennai", "Tamilnadu", "509832", "9654310542", "ganesh8@gmail.com") ;
